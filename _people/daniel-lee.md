...
name: 'Co-Mentor/ Clinical physican'
role: Co-Mentor
position: Co-Mentor/ Clinical physican
...
<div class="profile-header">
  ...
  <img src="{{ page.photo | relative_url }}" class="profile-photo" alt="{{ page.name }}">
...
<div  markdown="0" style="display:flex; gap:24px; align-items:flex-start; flex-wrap:wrap;">
  <div style="flex:0 0 220px;">
    <img 
      ...
      width="220"; border-radius:12px; object-fit:cover;"
