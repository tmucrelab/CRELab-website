...
categories: [lab-life]
tags: [event, lab-life]
event_type: academic   # seminar / social / academic
# 文章網址
# 建議和 title 對應
permalink: /life/20260311-event-template/
...
# ===== Lab Life 頁面卡片摘要 =====
# 這段會顯示在 /life/ 的卡片介紹
summary: "Write a short summary describing this event."
...
gallery_items:
  ...
  - type: video
    ...
    poster: /assets/assets/images/test-straight-photo.jpg #影片在集錦顯示的縮圖
---
